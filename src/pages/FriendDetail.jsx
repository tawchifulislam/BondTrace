      ...
      <div className="min-h-screen bg-[#f8fafc]">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-5">
              ...
              <div className="hidden md:flex flex-col gap-2 self-start">
                <button
                  onClick={openEditFriendModal}
                  className="flex items-center gap-2 text-sm text-white bg-[#244D3F] hover:bg-[#1b3a2f] rounded-full px-4 py-2 transition-colors"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 text-sm text-gray-500 hover:text-[#244D3F] border border-gray-200 rounded-full px-4 py-2 transition-colors"
                >
                  <HiOutlineMail /> Email
                </a>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Left: Quick Check-in + Recent Interactions */}
            ...
            {/* Right: Relationship Goal + Actions */}
            <div className="space-y-6">
              ...
              {/* Mobile-only edit + email */}
              <div className="md:hidden flex flex-col gap-2">
                <button
                  onClick={openEditFriendModal}
                  className="flex items-center justify-center gap-2 text-sm text-white bg-[#244D3F] hover:bg-[#1b3a2f] rounded-full px-4 py-3 transition-colors"
                >
                  <HiOutlinePencil /> Edit Profile
                </button>
                ...
                <a
                  href={`mailto:${friend.email}`}
                  className="flex items-center justify-center gap-2 text-sm text-gray-500 hover:text-[#244D3F] border border-gray-200 rounded-full px-4 py-3 transition-colors"
                >
